...
async function CarregarTemplate(nome){    
  ...
  async function CapturarDadosOrdemServico(){
    let idProfissional = document.querySelector('#idProfissional').value;  
    console.log(idProfissional);
    let idCliente = document.querySelector('#idCliente').value;  
    console.log(idCliente);
    let idServico = document.querySelector('#idServico').value;  
    console.log(idServico);
    let idItens = document.querySelector('#idItens').value;  
    console.log(idItens);
  ...
  function Adicionar()
{
    ...
    entrada.classList.add('entrada-produto');
  ...
  async function EnviarApi(viewmodel){
    ...
    const req =  await fetch('https://localhost:44363/ordensServico/Faturamento', options )
